...
<section class="wrapper">
    <div class="table-responsive ui stacked segment" style="">
        <div class="row">
          <h2 class="ui block header">Articles</h2>
        </div>
      ...
      <div class="eight fields">
        <div class="field">
          <select name="lang" id="lang">
            ...
            <option value="dr_article">dari</option>
            <option value="pa_article">pashto</option>
            <option value="en_article">English</option>
          </select>
        </div>
      </div>
    </div>
...
<table class="table">
  ...
  <tbody>
    ...
    ?>
    <tr>
      <th><img src="{{asset('uploads/media/article/'.$value->image)}}" style="width:100px;"></th>

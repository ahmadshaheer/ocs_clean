                        ...
                        <div class="form cmxform form-horizontal ">
                            ...
                            @if($session=='dr')
                              <div class="form-group ">
                                  ...
                                  <div class="col-lg-6">
                                      <input class=" form-control" maxlength="150" value="{{$document->title_dr}}" id="title_dr" name="title_dr" type="text">
                                  </div>
                              </div>
                              <div class="form-group ">
                                  <label for="date_dr" class="control-label col-lg-3">Date Dari</label>
                                  <div class="col-lg-6">
                                      <input class=" form-control date_dr" id="date_dr" vlaue="{{$document->date_dr}}" name="date_dr" type="text">
                                  </div>
                              </div>
                              <div class="form-group">
                            ...
                            @elseif ($session=='pa')
                              <div class="form-group ">
                                  ...
                                  <div class="col-lg-6">
                                      <input class=" form-control" maxlength="150" id="title_pa" value="{{$document->title_pa}}" name="title_pa" type="text">
                                  </div>
                              </div>

                            ...
                            <div class="form cmxform form-horizontal">
                                ...
                                @if($session=='dr')
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <input class=" form-control" id="title_dr" value="{{$media->title_dr}}" name="title_dr" type="text">
                                      </div>
                                  </div>
                                  <div class="form-group ">
                                  ...
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <textarea name="short_desc_dr" class="form-control"> {{$media->short_desc_dr}}</textarea>
                                      </div>
                                  </div>
                                  <div class="form-group ">
                                      <label for="desc_dr" class="control-label col-lg-3">Description Dari</label>
                                      <div class="col-lg-6">
                                          <textarea name="desc_dr" class="form-control format"> {{$media->description_dr}}</textarea>
                                      </div>
                                  </div>
                                ...
                                @elseif($session=='pa')
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <input class=" form-control" id="title_pa" value="{{$media->title_pa}}" name="title_pa" type="text">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <textarea name="short_desc_pa" class="form-control"> {{$media->short_desc_pa}}</textarea>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <textarea name="desc_pa" class="form-control format">{{$media->description_pa}}</textarea>
                                      </div>
                                  </div>

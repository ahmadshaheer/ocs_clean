                        ...
                        <div class="form cmxform form-horizontal ">
                            ...
                            @if($session=='dr')
                              <div class="form-group ">
                                  ...
                                  <div class="col-lg-6">
                                      <input class=" form-control" maxlength="150" value="{{$video->title_dr}}" id="title_dr" name="title_dr" type="text">
                                  </div>
                              </div>
                              ...
                              <div class="form-group ">
                                  ...
                                  <div class="col-lg-6">
                                      <input class=" form-control date_dr" id="date_dr" vlaue="{{$video->date_dr}}" name="date_dr" type="text">
                                  </div>
                              </div>
                            ...
                            @elseif($session=='pa')
                              <div class="form-group ">
                                  ...
                                  <div class="col-lg-6">
                                      <input class=" form-control" maxlength="150" id="title_pa" value="{{$video->title_pa}}" name="title_pa" type="text">
                                  </div>
                              </div>

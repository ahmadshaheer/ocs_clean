...
{{-- <script src="{{asset('assets/admin-asset/js/raphael-min.js')}}"></script>
<script src="{{asset('assets/admin-asset/js/morris.js')}}"></script>
<script src="{{asset('assets/admin-asset/js/morris.js')}}"></script> --}}
{{-- <script src="{{asset('assets/admin-asset/js/bootstrap.js')}}"></script> --}}
<script src="{{asset('assets/admin-asset/js/scripts.js')}}"></script>
{{-- <script src="{{asset('assets/admin-asset/js/jquery.slimscroll.js')}}"></script>
<script src="{{asset('assets/admin-asset/js/jquery.nicescroll.js')}}"></script> --}}
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="js/flot-chart/excanvas.min.js"></script><![endif]-->
<script src="{{asset('assets/admin-asset/js/jquery.scrollTo.js')}}"></script>
<script src="{{asset('assets/admin-asset/js/jquery.cropit.js')}}"></script>
<!-- morris JavaScript -->
<script >
$(function() {
  $('.image-editor').cropit();
...
<script src="{{asset('assets/js/tinymce/js/tinymce/tinymce.min.js')}}"></script>
 ...
 function show(lang){
    window.location = "{{url('admin/set_session_for_view?lang=')}}"+lang;
  }

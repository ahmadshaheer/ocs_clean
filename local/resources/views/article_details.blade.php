      ...
      <div class="ui centered container grid" id="main" style="display: flex">
        ...
        <div class="sixteen wide tablet mobile eleven wide computer column">
          <div class="ui fluid card" style="direction:rtl;float:right;text-align:right;">
            <div class="content">
              <h2 class="ui header title_font border">{{$article_details->$title}}</h2>
              <p class="meta body_font">{{$jdate->detailedDate($article_details->$date,$lang)}}</p>
              <div class="description">
                <p>{!!$article_details->$description!!}</p>
              </div>
              <!-- AddToAny BEGIN -->

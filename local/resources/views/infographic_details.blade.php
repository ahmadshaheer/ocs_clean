      ...
      <div class="ui centered container grid" id="main" style="display: flex">
        ...
        <div class="sixteen wide tablet mobile eleven wide computer column">
          ...
          <div class="ui fluid card" style="direction:rtl;float:right;text-align:right;">
            <div class="content">
              <h2 class="ui header title_font border">{{$info_details->$title}}</h2>
              <p class="meta body_font">{{$info_details->$date}}</p>

              <div style="padding-bottom: 10px">
                <img class="ui fluid image" src="{{asset('uploads/infographics/'.$info_details->image)}}">
              </div>

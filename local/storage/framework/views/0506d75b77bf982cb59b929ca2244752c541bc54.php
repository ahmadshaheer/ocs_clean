                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form cmxform form-horizontal">
                                <?php echo Form::model($the_president, ['route' => array('the_president.update',$the_president->id),'files' =>true]); ?>
                                ...
                                <?php if($session =='en'): ?>
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="title" maxlength="150" value="<?php echo e($the_president->title_en); ?>" name="title" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="date" class="control-label col-lg-3">Date</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="date" maxlength="10" value="<?php echo e($the_president->date_en); ?>"  name="date" type="date" required>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_en" class="form-control format"><?php echo e($the_president->description_en); ?></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($url=='word'): ?>
                                     <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="short_desc_dr" class="form-control"> <?php echo e($the_president->short_desc_dr); ?></textarea>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="title_dr" maxlength="150" value="<?php echo e($the_president->title_dr); ?>" name="title_dr" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="date_dr" class="control-label col-lg-3">Date Dari</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control date_dr"  maxlength="10" id="date_dr" value="<?php echo e($the_president->date_dr); ?>" name="date_dr" type="text" required>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_dr" class="form-control format"> <?php echo e($the_president->description_dr); ?></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="short_desc_pa" class="form-control"> <?php echo e($the_president->short_desc_pa); ?></textarea>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="title_pa" maxlength="150" value="<?php echo e($the_president->title_pa); ?>" name="title_pa" type="text">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_pa" class="form-control format"><?php echo e($the_president->description_pa); ?></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    <?php endif; ?>

                                ...
                                <?php if($session =='en'): ?>
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control date_dr rtl"   id="date_dr" value="<?php echo e($the_president->date_dr); ?>" name="date_dr" type="text" >
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_dr" class="form-control format rtl"> <?php echo e($the_president->description_dr); ?></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_pa" class="form-control format rtl"><?php echo e($the_president->description_pa); ?></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    <?php endif; ?>

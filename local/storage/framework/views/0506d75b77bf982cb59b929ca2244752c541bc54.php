                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <div class="form-group date_dari">
                                          ...
                                          <div class="col-lg-6">
                                            <input class="form-control change_date" disabled id="date_dr" value="<?php echo e($jdate->detailedDate($the_president->date_pa,$session)); ?>"  name="date_dr" type="text" required>
                                          </div>
                                      </div>
                                    <div class="form-group ">

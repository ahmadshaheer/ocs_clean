                                ...
                                <?php if($session =='en'): ?>
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="title_dr"  value="<?php echo e($the_president->title_dr); ?>" name="title_dr" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="date_dr" class="control-label col-lg-3">Date Dari</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control date_dr"   id="date_dr" value="<?php echo e($the_president->date_dr); ?>" name="date_dr" type="text" >
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="title_pa"  value="<?php echo e($the_president->title_pa); ?>" name="title_pa" type="text">
                                        </div>
                                    </div>

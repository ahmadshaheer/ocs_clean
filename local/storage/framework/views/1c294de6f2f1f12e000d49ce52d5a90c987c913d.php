                            ...
                            <div class="form cmxform form-horizontal">
                                ...
                                <input name="_method" type="hidden" value="PATCH">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="title" maxlength="150" value="<?php echo e($image->title_en); ?>" name="title" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="title_dr" class="control-label col-lg-3">Title Dari</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control rtl" id="title_dr" maxlength="150" value="<?php echo e($image->title_dr); ?>" name="title_dr" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="title_pa" class="control-label col-lg-3">Title Pashto</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control rtl" id="title_pa" maxlength="150" value="<?php echo e($image->title_pa); ?>" name="title_pa" type="text">
                                        </div>
                                    </div>

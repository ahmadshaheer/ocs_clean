                                ...
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="<?php echo e(route('the_bio.store')); ?>" enctype="multipart/form-data">
                                  ...
                                  <?php if($session =='en'): ?>
                                      <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="bio_en" value="<?php echo e(old('bio_en')); ?>" class="form-control format"></textarea>
                                        </div>
                                    </div>
                                    <?php elseif($session=='dr'): ?>
                                     <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="bio_dr" value="<?php echo e(old('bio_dr')); ?>" class="form-control format rtl"></textarea>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                     <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="bio_pa" value="<?php echo e(old('bio_pa')); ?>" class="form-control format rtl"></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>

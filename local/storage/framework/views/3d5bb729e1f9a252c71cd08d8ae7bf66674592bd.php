...
<div class="container pull-left" style="margin:10px;">
  <?php if(sizeof($ocs)==0 && Session::get('role')!='editor'): ?>
      <div class="ui form">
...
<table class="table">
  ...
  <tbody>
    <?php $__currentLoopData = $ocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    $description = "description_".$lang;
     ?>
    <tr>
      <td><div style="width:60em" class="test"><?php echo $value->$description; ?></div></td>
    </tr>
    <tr>
      <td>
      <form action="<?php echo e(route('the_ocs.destroy', $value->id)); ?>" method="POST">
...
<script>
  $("#lang").change(function(){
    var id = $(this).val();
    window.location = "<?php echo e(url('admin/set_session_all?lang=')); ?>"+id+"&route=<?php echo e(route('the_ocs.create')); ?>";
  });

  $(".edit_lang").change(function(){
    var lang = $(this).val().substring(0,2);
    var id = $(this).val().substring(3);
    window.location = "<?php echo e(url('admin/edit_session?lang=')); ?>"+lang+"&route=<?php echo e(url('admin/the_ocs/')); ?>"+"/"+id+"/edit";
  });

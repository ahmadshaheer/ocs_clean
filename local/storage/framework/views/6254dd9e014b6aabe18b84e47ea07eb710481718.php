...
<table class="table table-bordered" style="direction: <?php echo e($direction); ?>">
  ...
  <tbody>
    ...
    <tr>
      <th><?php echo e($i++); ?></th>
      <th><img src="<?php echo e(asset('uploads/trips/domestic/'.$value->image)); ?>" style="width:100px;"></th>
...
<script>
 function create(lang){
    ...
    window.location = "<?php echo e(url('admin/set_session?lang=')); ?>"+id+"&route=<?php echo e(route('trips.create')); ?>";
  }

  function edit(para){
    var lang = para.substring(0,2);
    var id = para.substring(3);
    window.location = "<?php echo e(url('admin/edit_session?lang=')); ?>"+lang+"&route=<?php echo e(url('admin/trips/')); ?>"+"/"+id+"/edit";
  }

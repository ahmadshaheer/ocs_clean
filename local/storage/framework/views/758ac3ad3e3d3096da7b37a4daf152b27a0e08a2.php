                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="form">
                              ...
                              <?php endif; ?>
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="<?php echo e(route('the_chief.store')); ?>" enctype="multipart/form-data">
                                  ...
                                  <?php if($session=='en'): ?>
                                    ...
                                    <?php elseif($session=='dr'): ?>
                                     <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_dr" value="<?php echo e(old('desc_dr')); ?>"class="form-control format"></textarea>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                     <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_pa" value="<?php echo e(old('desc_pa')); ?>"class="form-control format"></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>

        ...
        <div class="col-md-11">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                          ...
                          <?php endif; ?>
                            <div class="form">
                                <form class="cmxform form-horizontal " id="signupForm" method="post" action="<?php echo e(route('infographic.store')); ?>" enctype="multipart/form-data">
                                <?php if($session=='en'): ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="date" value="<?php echo e(old('date_en')); ?>" name="date_en" type="date">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control date_dr rtl"  value="<?php echo e(old('date_dr')); ?>" id="date_dr" name="date_dr" type="text">
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control date_dr rtl"  value="<?php echo e(old('date_dr')); ?>" id="date_pa" name="date_pa" type="text">
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                    <div class="form-group">

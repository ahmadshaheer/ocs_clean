                            ...
                            <div class="form cmxform form-horizontal">
                                ...
                                <?php elseif($session=='en'): ?>
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <input class=" form-control" id="title" maxlength="150" value="<?php echo e($info->title_en); ?>" name="title" type="text">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <input class=" form-control" id="date" maxlength="10" value="<?php echo e($info->date_en); ?>"  name="date" type="date" required>
                                      </div>
                                  </div>
                                <?php endif; ?>

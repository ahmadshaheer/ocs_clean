                            ...
                            <div class="form cmxform form-horizontal">
                                ...
                                <?php if($session=='dr'): ?>
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <input class=" form-control" id="title_dr" value="<?php echo e($trip->title_dr); ?>" name="title_dr" type="text">
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <input class=" form-control date_dr"  id="date_dr" value="<?php echo e($trip->date_dr); ?>" name="date_dr" type="text">
                                      </div>
                                  </div>
                                ...
                                <?php elseif($session=='pa'): ?>
                                  ...
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <input class=" form-control" id="title_pa" value="<?php echo e($trip->title_pa); ?>" name="title_pa" type="text">
                                      </div>
                                  </div>

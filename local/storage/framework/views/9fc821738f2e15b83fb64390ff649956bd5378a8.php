                            ...
                            <div class="form cmxform form-horizontal">
                                ...
                                <?php if($session=='dr'): ?>
                                  ...
                                  <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                      <input class=" form-control" id="title_dr" maxlength="150" value="<?php echo e($link->title_dr); ?>" name="title_dr" type="text">
                                    </div>
                                  </div>
                                ...
                                <?php elseif($session=='pa'): ?>
                                  <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <input class=" form-control" id="title_pa" maxlength="150" value="<?php echo e($link->title_pa); ?>" name="title_pa" type="text">
                                      </div>
                                  </div>
                                ...
                                <?php elseif($session=='en'): ?>
                                  ...
                                  <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                      <input class=" form-control" id="title" maxlength="150" value="<?php echo e($link->title_en); ?>" name="title" type="text">
                                    </div>
                                  </div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <input class="form-control" id="url" maxlength="150" name="url" value="<?php echo e($link->url); ?>" type="text">
                                    </div>
                                </div>

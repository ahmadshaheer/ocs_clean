                            ...
                            <div class="form">
                                ...
                                <?php if($session=='en'): ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control date_dr"  value="<?php echo e(old('date_dr')); ?>" id="date_dr" name="date_dr" type="text">
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="title_pa" value="<?php echo e(old('title_pa')); ?>" name="title_pa" type="text">
                                        </div>
                                    </div>

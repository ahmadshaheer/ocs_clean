        ...
        <div class="sixteen wide tablet mobile eleven wide computer column">
          <div class="ui fluid card" style="">
            <div class="ui breadcrumb" style="direction:<?php echo e($rtl); ?>">
              ...
              <a class="section"><?php echo e(trans('menu.domestic_trips')); ?></a>
            </div>
          </div>
          <div class="ui fluid card" style="direction:rtl;float:right;text-align:right;">
            <div class="content">
              <h2 class="ui header title_font border"><?php echo e($domestic_trip->$title); ?></h2>
              <p class="meta"><?php echo e($jdate->detailedDate($domestic_trip->$date,$lang)); ?></p>
              <div><?php echo $domestic_trip->$description; ?>
              </div>
              <!-- AddToAny BEGIN -->

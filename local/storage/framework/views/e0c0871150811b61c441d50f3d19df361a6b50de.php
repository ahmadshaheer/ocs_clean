                            ...
                            <div class="form">
                                ...
                                <?php if($session=='en'): ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_dr" class="form-control rtl"><?php echo e(old('desc_dr')); ?></textarea>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_pa" class="form-control rtl"><?php echo e(old('desc_pa')); ?></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                     <div class="form-group ">

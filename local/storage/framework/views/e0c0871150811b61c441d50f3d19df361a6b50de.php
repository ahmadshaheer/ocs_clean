                            ...
                            <div class="form">
                                ...
                                <?php if($session=='en'): ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="description_dr" class="form-control rtl"><?php echo e(old('description_dr')); ?></textarea>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class=" form-control rtl" id="title_pa" value="<?php echo e(old('title_pa')); ?>" name="" type="text">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="description_pa" class="control-label col-lg-3">Description Pashto</label>
                                        <div class="col-lg-6">
                                            <textarea name="description_pa" class="form-control rtl"><?php echo e(old('description_pa')); ?></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                     <div class="form-group ">

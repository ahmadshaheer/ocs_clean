                            ...
                            <div class="form">
                                ...
                                <?php if($session=='en'): ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_dr" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <?php else: ?>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <textarea name="desc_pa" class="form-control"></textarea>
                                        </div>
                                    </div>
                                    <?php endif; ?>
                                     <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                            <input class="form-control" id="url" maxlength="150" name="url" type="text">
                                        </div>
                                    </div>

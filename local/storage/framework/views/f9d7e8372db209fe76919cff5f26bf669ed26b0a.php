                                ...
                                <?php if($session=='en'): ?>
                                  ...
                                  <?php elseif($session=='dr'): ?>
                                   <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <textarea name="desc_dr" class="form-control format"><?php echo e($chief->desc_dr); ?></textarea>
                                      </div>
                                  </div>
                                  <?php else: ?>
                                   <div class="form-group ">
                                      ...
                                      <div class="col-lg-6">
                                          <textarea name="desc_pa" class="form-control format"><?php echo e($chief->desc_pa); ?></textarea>
                                      </div>
                                  </div>
                                  <?php endif; ?>

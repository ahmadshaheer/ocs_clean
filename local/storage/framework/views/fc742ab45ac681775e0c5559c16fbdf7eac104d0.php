                        ...
                        <div class="form cmxform form-horizontal ">
                            ...
                            <?php if($session=='dr'): ?>
                              <div class="form-group ">
                                  ...
                                  <div class="col-lg-6">
                                      <input class=" form-control" maxlength="150" value="<?php echo e($document->title_dr); ?>" id="title_dr" name="title_dr" type="text">
                                  </div>
                              </div>
                              <div class="form-group ">
                                  <label for="date_dr" class="control-label col-lg-3">Date Dari</label>
                                  <div class="col-lg-6">
                                      <input class=" form-control date_dr" id="date_dr" vlaue="<?php echo e($document->date_dr); ?>" name="date_dr" type="text">
                                  </div>
                              </div>
                              <div class="form-group">
                            ...
                            <?php elseif($session=='pa'): ?>
                              <div class="form-group ">
                                  ...
                                  <div class="col-lg-6">
                                      <input class=" form-control" maxlength="150" id="title_pa" value="<?php echo e($document->title_pa); ?>" name="title_pa" type="text">
                                  </div>
                              </div>
